package dev.kalles.sale.operator.support;
    ...
    private CsrfContext fetchCsrfToken() {
        ...
        try {
            ...
            if (response.statusCode() != 200) {
                throw new IllegalStateException("Falha ao obter token CSRF para os testes de operator.");
            }
            ...
            String csrfCookie = response.headers()
                    ...
                    .stream()
                    .map(AbstractOperatorApiSupport::extractCookieValue)
            ...
            throw new IllegalStateException("Falha ao ler a resposta CSRF de operator.", e);
        } catch (InterruptedException e) {
            Thread.currentThread().interrupt();
            throw new IllegalStateException("Requisicao CSRF interrompida durante os testes de operator.", e);
        }
    }
