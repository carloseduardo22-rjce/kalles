...
import dev.kalles.sale.fiscal.support.ControllableSefazAuthorizationPort;
...
class FiscalNfceApiIntegrationTest extends AbstractCashRegisterApiSupport {
    ...
    private UUID seedForeignTenantCompany() {
        tenantRepository.save(new dev.kalles.sale.core.entity.Tenant(OTHER_TENANT_ID, "Tenant Fiscal Externo"));
