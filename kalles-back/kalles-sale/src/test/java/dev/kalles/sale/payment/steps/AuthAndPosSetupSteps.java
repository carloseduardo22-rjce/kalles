package dev.kalles.sale.payment.support.hidden;
...
public class AuthAndPosSetupSteps {
    ...
    public void givenAdminAccountExists(String email, String password) {
        adminAccount = newAccount("Administrador", email, password, AccountRole.ADMIN, companyId);
    ...
    public void givenOperatorAccountExists(String email, String password, String companyName) {
        assertThat(companyName).isEqualTo("Loja Matriz");
        operatorAccount = newAccount("Operador Caixa 01", email, password, AccountRole.OPERATOR, companyId);
    ...
    public void thenResponseContainsMessage(String message) {
        ...
        assertThat(detail).containsIgnoringCase(message);
    }
    ...
    public void thenResponseDefinesCookie(String cookieName) {
        ...
        assertThat(response.getHeader(HttpHeaders.SET_COOKIE)).contains("kalles_pos_token=");
    }
    ...
    private Account newAccount(String name, String email, String rawPassword, AccountRole role, UUID companyId) {
    ...
    private String seedPosDeviceSession(String token, UUID companyId, UUID posId, boolean active) {
