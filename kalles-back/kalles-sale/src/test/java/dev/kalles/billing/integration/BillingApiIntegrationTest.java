...
import dev.kalles.billing.support.AbstractBillingApiSupport;
...
class BillingApiIntegrationTest extends AbstractBillingApiSupport {
    ...
    void shouldCreateCheckoutSessionForAuthenticatedTenant() {
        ...
        assertThat(billingSubscriptionRepository.findByTenantIdAndProvider(TENANT_ID, dev.kalles.billing.domain.BillingProvider.STRIPE)).isPresent();
    }
