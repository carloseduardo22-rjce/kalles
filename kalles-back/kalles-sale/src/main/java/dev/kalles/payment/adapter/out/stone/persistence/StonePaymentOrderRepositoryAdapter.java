package dev.kalles.payment.adapter.out.stone.persistence;

import dev.kalles.payment.adapter.out.stone.persistence.entity.StonePaymentOrderEntity;
import dev.kalles.payment.adapter.out.stone.persistence.repository.StonePaymentOrderJpaRepository;
