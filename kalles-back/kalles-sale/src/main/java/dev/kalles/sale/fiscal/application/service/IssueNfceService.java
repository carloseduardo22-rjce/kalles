...
import dev.kalles.sale.fiscal.application.port.in.IssueNfceCommand;
import dev.kalles.sale.fiscal.application.port.in.IssueNfceUseCase;
...
import dev.kalles.sale.fiscal.application.port.out.FiscalIssuerAddressRepository;
import dev.kalles.sale.fiscal.application.port.out.FiscalIssuerProfileRepository;
