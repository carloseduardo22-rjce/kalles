package dev.kalles.sale.payment.adapter.out.persistence;

import dev.kalles.sale.payment.adapter.out.persistence.entity.PaymentTerminalMappingEntity;
import dev.kalles.sale.payment.adapter.out.persistence.repository.PaymentTerminalMappingJpaRepository;
