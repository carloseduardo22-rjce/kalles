...
import dev.kalles.sale.core.dto.ProductLocationStockView;
...
public interface ProductStockQueryRepository extends Repository<Stock, UUID> {
    ...
    @Query("""
        SELECT new dev.kalles.sale.core.dto.ProductStockSummary(
    ...
    @Query("""
        SELECT new dev.kalles.sale.core.dto.ProductLocationStockView(
